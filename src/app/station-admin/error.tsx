...
export default function StationAdminError({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 dark:from-blue-950 via-white dark:via-zinc-900 to-indigo-50 dark:to-indigo-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white dark:bg-zinc-900 rounded-2xl shadow-xl p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Station Admin Error</h1>
        <p className="text-gray-600 dark:text-zinc-400 mb-6">
          Something went wrong loading station administration. Please try again.
        </p>
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/"
            className="w-full inline-flex items-center justify-center space-x-2 border-2 border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-300 px-6 py-3 rounded-lg hover:border-blue-400 transition-colors font-medium"
          >
