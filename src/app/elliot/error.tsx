    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-sky-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/"
            className="w-full inline-flex items-center justify-center space-x-2 border-2 border-cyan-300 text-cyan-700 px-6 py-3 rounded-lg hover:border-cyan-400 transition-colors font-medium"
          >
