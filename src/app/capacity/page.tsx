            ...
            <div className="bg-white dark:bg-zinc-900 rounded-lg p-6">
              ...
              <div className="pt-4 border-t space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-zinc-400">Total Artists</span>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-lg p-6">
              ...
              <div className="pt-4 border-t space-y-2">
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-sm text-gray-600 dark:text-zinc-400">Base Package Sponsors</div>
    ...
    <div className="bg-white dark:bg-zinc-900 rounded-lg p-6">
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          <span className="text-gray-600 dark:text-zinc-400">Slots Available</span>
          <span className="font-semibold">{slots}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span className="text-gray-600 dark:text-zinc-400">Price per Slot</span>
