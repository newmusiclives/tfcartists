  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-white to-amber-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3">Your Station is Live!</h1>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-10">
          ...
          >
            ...
            <div>
              <p className="font-semibold text-gray-900">Upload Music</p>
              <p className="text-sm text-gray-500">Add tracks to your station library</p>
            </div>
          ...
          >
            ...
            <div>
              <p className="font-semibold text-gray-900">Customize DJs</p>
              <p className="text-sm text-gray-500">Edit AI DJ personalities and voices</p>
            </div>
            <ArrowRight className="w-4 h-4 text-gray-400 ml-auto" />
          </Link>
          ...
          >
            ...
            <div>
              <p className="font-semibold text-gray-900">Set Schedule</p>
              <p className="text-sm text-gray-500">Configure show times and rotations</p>
            </div>
            <ArrowRight className="w-4 h-4 text-gray-400 ml-auto" />
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Configure stream, payments, API keys</p>
            </div>
            <ArrowRight className="w-4 h-4 text-gray-400 ml-auto" />
          </Link>
        </div>
