...
export default function ArtistOpportunityPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-orange-50 dark:from-orange-950 via-white dark:via-zinc-900 to-purple-50 dark:to-purple-950">
      <SharedNav />
            ...
            <div className="flex items-center space-x-2 bg-gray-100 dark:bg-zinc-800 rounded-lg p-1">
              <button
                ...
                className={`px-4 py-2 rounded-md font-semibold transition-all ${
                  capacity === "60"
                    ? "bg-white dark:bg-zinc-900 text-orange-700 dark:text-orange-300 shadow"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
            {/* Free */}
            <div className="rounded-lg p-5 border-2 border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900 flex flex-col">
              ...
              <div className="text-sm text-gray-600 dark:text-zinc-400 mb-3">forever</div>
            ...
            {/* Bronze */}
            <div className="rounded-lg p-5 border-2 border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950 flex flex-col">
              <h3 className="font-bold text-lg text-orange-900 dark:text-orange-200 mb-1">Bronze</h3>
              <div className="text-3xl font-bold text-orange-600 dark:text-orange-300 mb-1">$5<span className="text-base font-normal">/mo</span></div>
            ...
            {/* Silver */}
            <div className="rounded-lg p-5 border-2 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950 flex flex-col">
              <h3 className="font-bold text-lg text-blue-900 dark:text-blue-200 mb-1">Silver</h3>
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-300 mb-1">$15<span className="text-base font-normal">/mo</span></div>
            ...
            {/* Gold - Most Popular */}
            <div className="rounded-lg p-5 border-4 border-yellow-400 bg-yellow-50 dark:bg-yellow-950 flex flex-col relative">
              ...
              <h3 className="font-bold text-lg text-yellow-900 dark:text-yellow-200 mb-1">Gold</h3>
              <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-300 mb-1">$40<span className="text-base font-normal">/mo</span></div>
              <div className="text-sm text-yellow-600 dark:text-yellow-300 font-semibold mb-3">Less than Netflix</div>
            ...
            {/* Platinum */}
            <div className="rounded-lg p-5 border-2 border-purple-300 dark:border-purple-700 bg-gradient-to-br from-purple-50 dark:from-purple-950 to-purple-100 dark:to-purple-950 flex flex-col">
              <h3 className="font-bold text-lg text-purple-900 dark:text-purple-200 mb-1">Platinum</h3>
              <div className="text-3xl font-bold text-purple-600 dark:text-purple-300 mb-1">$100<span className="text-base font-normal">/mo</span></div>
          ...
          <div className="bg-gradient-to-r from-green-50 dark:from-green-950 to-emerald-50 dark:to-emerald-950 rounded-lg p-4 border border-green-200 dark:border-green-800 text-center">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-6">
          <h2 className="text-2xl font-bold mb-6 flex items-center">
            <DollarSign className="w-6 h-6 mr-2 text-orange-600 dark:text-orange-300" />
            How You Earn Money
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            <div className="bg-orange-50 dark:bg-orange-950 rounded-lg p-4 border-2 border-orange-200 dark:border-orange-800">
              <h3 className="font-semibold text-orange-900 dark:text-orange-200 mb-2">First 3 Months</h3>
              <div className="text-3xl font-bold text-orange-600 dark:text-orange-300 mb-1">{scoutModel.commissions.first3Months}</div>
              <p className="text-sm text-orange-700 dark:text-orange-300">Of artist's subscription for their first 3 months</p>
            </div>

            <div className="bg-purple-50 dark:bg-purple-950 rounded-lg p-4 border-2 border-purple-200 dark:border-purple-800">
              <h3 className="font-semibold text-purple-900 dark:text-purple-200 mb-2">Ongoing Commission</h3>
              <div className="text-3xl font-bold text-purple-600 dark:text-purple-300 mb-1">{scoutModel.commissions.ongoing}</div>
              <p className="text-sm text-purple-700 dark:text-purple-300">Of artist's subscription every month after that</p>
            </div>

            <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-4 border-2 border-blue-200 dark:border-blue-800">
              <h3 className="font-semibold text-blue-900 dark:text-blue-200 mb-2">Prepurchase Bonus</h3>
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-300 mb-1">{scoutModel.commissions.prepurchase}</div>
              <p className="text-sm text-blue-700 dark:text-blue-300">When artist prepurchases annual subscription</p>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gradient-to-r from-yellow-100 dark:from-yellow-950 to-yellow-200 rounded-lg p-4 border-2 border-yellow-400">
              <h3 className="font-semibold text-yellow-900 dark:text-yellow-200 mb-2">🎁 Upgrade Bonuses</h3>
              <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-300 mb-1">{scoutModel.commissions.upgradeBonuses}</div>
              <p className="text-sm text-yellow-700 dark:text-yellow-300">Every time your referred artist upgrades their tier</p>
            </div>

            <div className="bg-gradient-to-r from-pink-100 dark:from-pink-950 to-pink-200 rounded-lg p-4 border-2 border-pink-400">
              <h3 className="font-semibold text-pink-900 dark:text-pink-200 mb-2">✨ Influence Bonuses</h3>
              <div className="text-2xl font-bold text-pink-600 dark:text-pink-300 mb-1">{scoutModel.commissions.influenceBonuses}</div>
              <p className="text-sm text-pink-700 dark:text-pink-300">For each artist influenced by your referrals (viral growth!)</p>
            </div>
          </div>
        </div>

        {/* Milestone Bonuses */}
        <div className="bg-gradient-to-br from-yellow-50 dark:from-yellow-950 to-orange-50 dark:to-orange-950 rounded-xl shadow-lg p-6 border-2 border-yellow-300 dark:border-yellow-700">
          <h2 className="text-2xl font-bold mb-4 flex items-center">
            <Trophy className="w-6 h-6 mr-2 text-yellow-600 dark:text-yellow-300" />
            Milestone Bonuses
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 border-2 border-yellow-400">
              ...
              <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-300 mb-2">{scoutModel.milestones.artists5}</div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 border-2 border-orange-400">
              ...
              <div className="text-3xl font-bold text-orange-600 dark:text-orange-300 mb-2">{scoutModel.milestones.artists10}</div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-6">
          <h2 className="text-2xl font-bold mb-6 flex items-center">
            <Star className="w-6 h-6 mr-2 text-orange-600 dark:text-orange-300" />
            Performance Tiers - Quality Over Quantity
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-gradient-to-br from-yellow-50 dark:from-yellow-950 to-orange-100 dark:to-orange-950 rounded-lg p-6 border-4 border-yellow-400 relative">
              ...
              <div className="text-2xl font-bold text-orange-600 dark:text-orange-300 mb-2">{scoutModel.tiers.elite.range}</div>
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-2">{scoutModel.tiers.elite.count} artist promoters</p>
              <p className="text-xs text-gray-600 dark:text-zinc-400">{scoutModel.tiers.elite.description}</p>
            </div>

            <div className="bg-gradient-to-br from-orange-50 dark:from-orange-950 to-orange-100 dark:to-orange-950 rounded-lg p-6 border-2 border-orange-300 dark:border-orange-700">
              <div className="text-3xl mb-2">⭐</div>
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mb-1">{scoutModel.tiers.strong.name}</h3>
              <div className="text-2xl font-bold text-orange-600 dark:text-orange-300 mb-2">{scoutModel.tiers.strong.range}</div>
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-2">{scoutModel.tiers.strong.count} artist promoters</p>
              <p className="text-xs text-gray-600 dark:text-zinc-400">{scoutModel.tiers.strong.description}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 dark:from-purple-950 to-purple-100 dark:to-purple-950 rounded-lg p-6 border-2 border-purple-200 dark:border-purple-800">
              ...
              <div className="text-2xl font-bold text-purple-600 dark:text-purple-300 mb-2">{scoutModel.tiers.active.range}</div>
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-2">{scoutModel.tiers.active.count} artist promoters</p>
              <p className="text-xs text-gray-600 dark:text-zinc-400">{scoutModel.tiers.active.description}</p>
            </div>

            <div className="bg-gradient-to-br from-gray-50 dark:from-zinc-950 to-gray-100 dark:to-zinc-900 rounded-lg p-6 border-2 border-gray-200 dark:border-zinc-800">
              <div className="text-3xl mb-2">🌱</div>
              ...
              <p className="text-xs text-gray-600 dark:text-zinc-400">{scoutModel.tiers.developing.description}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-6">
          <h2 className="text-2xl font-bold mb-6 flex items-center">
            <Users className="w-6 h-6 mr-2 text-purple-600 dark:text-purple-300" />
            Real Artist Promoter Examples
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {examples.map((example, idx) => (
              <div key={idx} className="bg-gradient-to-br from-purple-50 dark:from-purple-950 to-blue-50 dark:to-blue-950 rounded-lg p-6 border-2 border-purple-200 dark:border-purple-800">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold text-orange-600 dark:text-orange-300">{example.tier}</span>
                  </div>
                </div>
                <div className="bg-white dark:bg-zinc-900 rounded-lg p-4 mb-3">
                  ...
                  <div className="text-3xl font-bold text-green-600 dark:text-green-300">{example.monthly}</div>
                </div>
                <div className="bg-green-50 dark:bg-green-950 rounded-lg p-3 mb-3">
                  <div className="text-xs text-green-700 dark:text-green-300 mb-1">Annual Projection</div>
                  <div className="text-xl font-bold text-green-600 dark:text-green-300">{example.annual}</div>
                </div>
        ...
        <div className="bg-gradient-to-br from-green-600 via-blue-600 to-purple-600 rounded-xl shadow-2xl p-8 text-white">
          ...
          <div className="bg-white dark:bg-zinc-900/10 backdrop-blur rounded-lg p-6 mb-6">
          ...
          <div className="text-center bg-yellow-400 text-gray-900 dark:text-zinc-100 rounded-lg p-6">
