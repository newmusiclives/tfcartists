          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border p-6">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h2 className="font-semibold text-gray-900 dark:text-white">Peak Listening Hours</h2>
                </div>
                {(() => {
            ...
            {data.campaignComparison.length > 1 && (
              <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border p-6 mb-6">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h2 className="font-semibold text-gray-900 dark:text-white">Campaign Comparison</h2>
                </div>
                    ...
                    <tbody>
                      {data.campaignComparison.map((c) => (
                        <tr key={c.id} className="border-b border-gray-50">
                          ...
                          <td className="py-3 pr-4 text-right text-gray-900 dark:text-white font-medium">${c.monthlyAmount}</td>
            ...
            {data.adBreakdown.length > 0 && (
              <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border p-6">
                <div className="flex items-center gap-2 mb-6">
                  <Megaphone className="w-5 h-5 text-gray-400" />
                  <h2 className="font-semibold text-gray-900 dark:text-white">Ad Performance Breakdown</h2>
                </div>
                <div className="space-y-3">
                  {(() => {
