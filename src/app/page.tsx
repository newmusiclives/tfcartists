      ...
      <section className="py-20 border-t border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/sponsor"
              className="inline-flex items-center space-x-2 bg-green-700 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-green-500 transition-colors w-full sm:w-auto justify-center"
            >
            ...
            <Link
              href="/operate"
              className="inline-flex items-center space-x-2 bg-amber-700 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-amber-500 transition-colors w-full sm:w-auto justify-center"
            >
              <Radio className="w-5 h-5" />
              <span>Launch a Station</span>
            </Link>
