  ...
  return (
    <main className="min-h-screen bg-zinc-950">
      ...
      <div className="max-w-4xl mx-auto px-4 pb-20 space-y-10">
        ...
        <section className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-amber-50 dark:bg-amber-950 rounded-lg p-6 border border-amber-100">
              ...
              <p className="text-sm text-amber-700 dark:text-amber-300 font-medium mb-3">ascap.com</p>
              <p className="text-gray-700 dark:text-zinc-200 text-sm">
            ...
            <div className="bg-amber-50 dark:bg-amber-950 rounded-lg p-6 border border-amber-100">
              ...
              <p className="text-sm text-amber-700 dark:text-amber-300 font-medium mb-3">bmi.com</p>
              <p className="text-gray-700 dark:text-zinc-200 text-sm">
            ...
            <div className="bg-amber-50 dark:bg-amber-950 rounded-lg p-6 border border-amber-100">
              ...
              <p className="text-sm text-amber-700 dark:text-amber-300 font-medium mb-3">sesac.com</p>
              <p className="text-gray-700 dark:text-zinc-200 text-sm">
        ...
        <section className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center space-x-2">
            <Radio className="w-6 h-6 text-amber-600 dark:text-amber-300" />
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={item} className="flex items-start space-x-3">
                <CheckCircle2 className="w-5 h-5 text-amber-600 dark:text-amber-300 mt-0.5 flex-shrink-0" />
        ...
        <section className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center space-x-2">
            <ExternalLink className="w-6 h-6 text-amber-600 dark:text-amber-300" />
            <span>Resources</span>
          </h2>
            ...
            {[
              ...
              <li key={link.label}>
                <a
                  ...
                  className="inline-flex items-center space-x-2 text-amber-700 dark:text-amber-300 hover:text-amber-800 font-medium transition-colors"
                >
        ...
        <section className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-xl shadow-lg p-10 text-center">
          ...
          <Link
            href="/operate"
            className="inline-block bg-white dark:bg-zinc-900 text-amber-700 dark:text-amber-300 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-amber-50 transition-colors shadow-lg"
          >
            Start Your Station
          </Link>
        </section>
