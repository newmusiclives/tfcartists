...
export default function CassidyError({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 dark:from-pink-950 via-white dark:via-zinc-900 to-rose-50 dark:to-rose-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white dark:bg-zinc-900 rounded-2xl shadow-xl p-8 text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-pink-100 dark:bg-pink-900 rounded-full mb-6">
          <AlertCircle className="w-10 h-10 text-pink-600 dark:text-pink-300" />
        </div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Cassidy Dashboard Error</h1>
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/"
            className="w-full inline-flex items-center justify-center space-x-2 border-2 border-pink-300 dark:border-pink-700 text-pink-700 dark:text-pink-300 px-6 py-3 rounded-lg hover:border-pink-400 transition-colors font-medium"
          >
