    ...
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border p-6 animate-pulse">
          <div className="h-5 w-52 bg-gray-200 dark:bg-zinc-800 rounded mb-2" />
          <div className="h-3 w-32 bg-gray-100 dark:bg-zinc-800 rounded mb-5" />
          <div className="flex items-end justify-between gap-2" style={{ height: 180 }}>
            {[...Array(7)].map((_, i) => (
              <div key={i} className="flex-1 flex flex-col items-center justify-end h-full">
                <div
                  className="w-full max-w-[48px] bg-gray-200 dark:bg-zinc-800 rounded-t-md"
                  style={{ height: 40 + Math.random() * 100 }}
                />
                <div className="mt-2 h-3 w-8 bg-gray-100 dark:bg-zinc-800 rounded" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {[...Array(2)].map((_, i) => (
            ...
            >
              <div className="h-5 w-40 bg-gray-200 dark:bg-zinc-800 rounded mb-2" />
              <div className="h-3 w-48 bg-gray-100 dark:bg-zinc-800 rounded mb-5" />
              <div className="space-y-4">
                {[...Array(4)].map((_, j) => (
                  <div key={j}>
                    ...
                    <div className="h-3 bg-gray-100 dark:bg-zinc-800 rounded-full" />
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* 5. Top songs table */}
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border p-6 animate-pulse">
          <div className="h-5 w-44 bg-gray-200 dark:bg-zinc-800 rounded mb-4" />
        ...
        {/* 6. Revenue breakdown */}
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm border p-6 animate-pulse">
          <div className="h-5 w-40 bg-gray-200 dark:bg-zinc-800 rounded mb-5" />
