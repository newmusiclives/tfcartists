  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 dark:from-green-950 via-white dark:via-zinc-900 to-blue-50 dark:to-blue-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div className="flex items-center">
              <div className="flex-1">
                <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-4 border-2 border-blue-200 dark:border-blue-800">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-blue-600 dark:text-blue-300 font-semibold">SPONSORS PAY</div>
                      <div className="text-2xl font-bold text-blue-900 dark:text-blue-200">${totalSponsorRevenue.toLocaleString()}/mo</div>
                      <div className="text-sm text-blue-700 dark:text-blue-300">{totalSponsors} active sponsors</div>
                    </div>
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="bg-green-50 dark:bg-green-950 rounded-lg p-4 border-2 border-green-200 dark:border-green-800">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-green-600 dark:text-green-300 font-semibold">80% → ARTIST POOL</div>
                      <div className="text-2xl font-bold text-green-900 dark:text-green-200">${artistPoolContribution.toLocaleString()}</div>
                      <div className="text-sm text-green-700 dark:text-green-300">{totalArtists} artists share</div>
                    </div>
                ...
                <div className="bg-orange-50 dark:bg-orange-950 rounded-lg p-4 border-2 border-orange-200 dark:border-orange-800">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-orange-600 dark:text-orange-300 font-semibold">20% → STATION</div>
                      <div className="text-2xl font-bold text-orange-900 dark:text-orange-200">${stationRevenue.toLocaleString()}</div>
                      <div className="text-sm text-orange-700 dark:text-orange-300">Operations & growth</div>
                    </div>
            ...
            <div className="flex items-center">
              <div className="flex-1">
                <div className="bg-purple-50 dark:bg-purple-950 rounded-lg p-4 border-2 border-purple-200 dark:border-purple-800">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-purple-600 dark:text-purple-300 font-semibold">ARTIST SUBSCRIPTIONS</div>
                      <div className="text-2xl font-bold text-purple-900 dark:text-purple-200">${totalArtistSubscriptions.toLocaleString()}/mo</div>
                      <div className="text-sm text-purple-700 dark:text-purple-300">Airplay tier fees</div>
                    </div>
              ...
              <div className="flex-1">
                <div className="bg-orange-50 dark:bg-orange-950 rounded-lg p-4 border-2 border-orange-200 dark:border-orange-800">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-orange-600 dark:text-orange-300 font-semibold">100% → STATION</div>
                      <div className="text-2xl font-bold text-orange-900 dark:text-orange-200">${totalArtistSubscriptions.toLocaleString()}</div>
                      <div className="text-sm text-orange-700 dark:text-orange-300">Retained for operations</div>
                    </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-sm text-gray-600 dark:text-zinc-400">
              Per-share value: <span className="font-bold text-green-600 dark:text-green-300">${perShareValue.toFixed(2)}</span>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {Object.entries(artistTiers).map(([tier, data]) => (
                <div key={tier} className="bg-gray-50 dark:bg-zinc-900 rounded-lg p-4 border">
                  <div className="text-sm font-semibold text-gray-600 dark:text-zinc-400 mb-2">{tier.replace('_', ' ')}</div>
                  <div className="text-xs text-gray-600 dark:text-zinc-400 mb-3">{data.count} artists</div>
                ...
                <tbody>
                  {topArtists.map((artist, idx) => (
                    <tr key={idx} className="border-b hover:bg-gray-50 dark:hover:bg-zinc-800">
                      ...
                      <td className="py-3 px-4 text-right text-red-600 dark:text-red-300">-${artist.subscription}</td>
                      <td className="py-3 px-4 text-right">{artist.shares}</td>
                      <td className="py-3 px-4 text-right text-green-600 dark:text-green-300">+${artist.poolEarnings.toFixed(2)}</td>
                      <td className="py-3 px-4 text-right text-blue-600 dark:text-blue-300">+${artist.liveShowDonations}</td>
          ...
          <div className="mt-6 bg-green-50 dark:bg-green-950 rounded-lg p-4 border border-green-200 dark:border-green-800">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {Object.entries(sponsorTiers).map(([tier, data]) => (
                <div key={tier} className="bg-blue-50 dark:bg-blue-950 rounded-lg p-4 border-2 border-blue-200 dark:border-blue-800">
                  <div className="text-lg font-bold text-blue-900 dark:text-blue-200 mb-2">{tier}</div>
                  <div className="text-sm text-blue-700 dark:text-blue-300 mb-4">{data.count} sponsors</div>

                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-blue-600 dark:text-blue-300">Per sponsor:</span>
                      <span className="font-semibold">${data.monthly}/mo</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-blue-600 dark:text-blue-300">Ad spots:</span>
                    ...
                    <div className="flex justify-between pt-2 border-t border-blue-300 dark:border-blue-700">
                      <span className="text-blue-600 dark:text-blue-300">Group total:</span>
                      <span className="font-bold text-blue-900 dark:text-blue-200">${data.total.toLocaleString()}/mo</span>
                    </div>
                  </div>
                </div>
              ))}
                ...
                <tbody>
                  {topSponsors.map((sponsor, idx) => (
                    <tr key={idx} className="border-b hover:bg-gray-50 dark:hover:bg-zinc-800">
                      ...
                      <td className="py-3 px-4 text-right font-semibold text-blue-600 dark:text-blue-300">
                        ${sponsor.monthly}
                      </td>
        ...
        {/* Station Net Revenue */}
        <div className="bg-gradient-to-br from-orange-50 dark:from-orange-950 to-orange-100 dark:to-orange-950 rounded-xl shadow-lg p-6 border-2 border-orange-200 dark:border-orange-800">
          <h2 className="text-2xl font-bold mb-6 text-orange-900 dark:text-orange-200">TrueFans RADIO™ Net Revenue</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              <h3 className="text-lg font-semibold text-orange-800 dark:text-orange-200 mb-4">Revenue Sources</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-white dark:bg-zinc-900 rounded-lg">
                  ...
                  <span className="font-bold text-green-600 dark:text-green-300">${stationRevenue.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white dark:bg-zinc-900 rounded-lg">
                  <span className="text-gray-700 dark:text-zinc-300">Artist Subscriptions (100%)</span>
                  <span className="font-bold text-green-600 dark:text-green-300">${totalArtistSubscriptions.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-orange-100 dark:bg-orange-900 rounded-lg border-2 border-orange-300 dark:border-orange-700">
                  <span className="font-semibold text-orange-900 dark:text-orange-200">Total Station Revenue</span>
                  <span className="font-bold text-xl text-orange-900 dark:text-orange-200">${netStationRevenue.toLocaleString()}</span>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-orange-800 dark:text-orange-200 mb-4">Operating Expenses (Estimated)</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-white dark:bg-zinc-900 rounded-lg">
                ...
                <div className="flex justify-between items-center p-3 bg-orange-100 dark:bg-orange-900 rounded-lg border-2 border-orange-300 dark:border-orange-700">
                  <span className="font-semibold text-orange-900 dark:text-orange-200">Total Expenses</span>
                  <span className="font-bold text-xl text-orange-900 dark:text-orange-200">$5,000</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 bg-white dark:bg-zinc-900 rounded-lg p-4 border border-orange-200 dark:border-orange-800">
            <div className="text-sm text-gray-700 dark:text-zinc-300">
              <strong className="text-orange-900 dark:text-orange-200">Revenue Model:</strong> Station keeps 20% of sponsor revenue
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
              <div className="text-3xl font-bold text-purple-600 dark:text-purple-300">{totalArtists}</div>
              <div className="text-sm text-purple-700 dark:text-purple-300">Active Artists</div>
              <div className="text-xs text-purple-600 dark:text-purple-300 mt-2">Avg: ${(artistPoolContribution / totalArtists).toFixed(2)}/artist from pool</div>
            </div>

            <div className="text-center p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-300">{totalSponsors}</div>
              <div className="text-sm text-blue-700 dark:text-blue-300">Active Sponsors</div>
              <div className="text-xs text-blue-600 dark:text-blue-300 mt-2">Avg: ${(totalSponsorRevenue / totalSponsors).toFixed(2)}/sponsor</div>
            </div>

            <div className="text-center p-4 bg-green-50 dark:bg-green-950 rounded-lg">
              <div className="text-3xl font-bold text-green-600 dark:text-green-300">${totalMonthlyRevenue.toLocaleString()}</div>
              <div className="text-sm text-green-700 dark:text-green-300">Total Monthly Revenue</div>
              <div className="text-xs text-green-600 dark:text-green-300 mt-2">Annual: ${(totalMonthlyRevenue * 12).toLocaleString()}</div>
            </div>
          </div>
        </div>
      </div>
