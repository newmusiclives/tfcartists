    ...
    data: {
      ...
      metadata: {
        ...
        scripts: {
          ...
          commercial: [
            { label: "TFC - Direct Support", text: "Support the artists you love — live and in person. True Fans CONNECT is the free app that helps you discover shows near you and put money directly in artists' hands. Eighty percent of every donation goes straight to the musician. Find your next favorite artist at truefansconnect dot com.", musicBed: "Warm acoustic guitar arpeggios over soft kick drum pulse, uplifting and sincere, 20 seconds" },
            ...
            { label: "TFC - No Middlemen", text: "Artists keep eighty percent of every fan donation on True Fans CONNECT. No middlemen. No algorithms. Just real fans supporting real music. Download the app free at truefansconnect dot com.", musicBed: "Driving acoustic rhythm guitar with upright bass, determined and hopeful, 15 seconds" },
