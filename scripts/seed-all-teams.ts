    ...
    data: {
      ...
      metadata: {
        ...
        scripts: {
          ...
          commercial: [
            { label: "TFC - Direct Support", text: "Support the artists you love — live and in person. True Fans CONNECT is the free app that helps you discover shows near you and put money directly in artists' hands. Ninety-two percent of every donation goes straight to the musician. No middlemen, no platform fees. Find your next favorite artist at truefansconnect dot com.", musicBed: "Warm acoustic guitar arpeggios over soft kick drum pulse, uplifting and sincere, 20 seconds" },
            { label: "AMP Newsletter", text: "The AMP Newsletter — your weekly backstage pass to independent music. Artist spotlights, industry moves, and the tools singer-songwriters actually need. Free every week at newmusiclives dot com.", musicBed: "Bright piano riff with light electric guitar, indie-folk energy, 15 seconds" },
            { label: "Lightwork Digital - Big Reach", text: "Small business, big reach. Lightwork Digital builds the websites, runs the ads, and handles the SEO so you can focus on what you do best. From Albuquerque to anywhere — lightworkdigital dot com.", musicBed: "Confident mid-tempo beat with clean electric guitar and bass groove, modern and professional, 15 seconds" },
            { label: "Fox & Bones - PNW Award", text: "Fox and Bones — the Portland folk duo you need in your life. Their album Long Time Honey won Best Folk Americana Album at the PNW Music Awards. Stream it now and catch them on tour at foxandbones dot com.", musicBed: "Folk-pop acoustic strum with hand claps and light tambourine, warm and joyful, 15 seconds" },
            { label: "TFC - No Middlemen", text: "Artists keep ninety-two percent of every fan donation on True Fans CONNECT. No middlemen. No algorithms. No platform fees eating into their earnings. Just real fans supporting real music. Download the app free at truefansconnect dot com.", musicBed: "Driving acoustic rhythm guitar with upright bass, determined and hopeful, 15 seconds" },
            { label: "Lightwork Digital - Discovery Call", text: "Need more customers finding you online? Lightwork Digital does local SEO, Google ads, and social media management — all in one place. Book a free discovery call at lightworkdigital dot com.", musicBed: "Upbeat ukulele and light percussion with subtle synth pad, friendly and approachable, 15 seconds" },
          ],
        },
      },
    },
    ...
    data: {
      ...
      metadata: {
        ...
        scripts: {
          ...
          commercial: [
            { label: "TFC - Live Donation", text: "Going to a show tonight? Open True Fans CONNECT and send your favorite artist a donation right from your seat. It's the easiest way to say 'that song changed my night.' truefansconnect dot com.", musicBed: "Intimate fingerpicked guitar with soft strings, heartfelt and personal, 15 seconds" },
            { label: "AMP - For Artists", text: "If you're an independent artist trying to make it, you need the AMP. It's the newsletter built for singer-songwriters who want real advice, not hype. Subscribe free at newmusiclives dot com.", musicBed: "Lo-fi acoustic guitar with subtle beat, authentic and grounded, 15 seconds" },
            { label: "Lightwork Digital - Search", text: "Your customers are searching for you right now. Are they finding you? Lightwork Digital gets local businesses to the top of search results. Visit lightworkdigital dot com.", musicBed: "Punchy pop-rock guitar riff with confident drum groove, energetic and direct, 12 seconds" },
            { label: "Fox & Bones - Scott & Sarah", text: "Scott and Sarah are Fox and Bones — equal parts folk, pop, Americana, and soul. Founders of Portland's Folk Festival and one of the hardest-working duos on the road. Hear them at foxandbones dot com.", musicBed: "Warm duo acoustic guitar and vocal harmony pad, storytelling feel, 15 seconds" },
            { label: "AMP - Community", text: "New Music Lives — where independent artists find their voice. Get the AMP Newsletter, join the private community, and download the TrueFans Manifesto free at newmusiclives dot com.", musicBed: "Building acoustic strum with group hand claps, community and momentum feel, 15 seconds" },
            { label: "Fox & Bones - Good Vibes", text: "If you love Americana with heart and a smile, you'll love Fox and Bones. Album of the year, stages across the country, and genuine good vibes. foxandbones dot com.", musicBed: "Bright mandolin and acoustic guitar duet, sunny and uplifting, 12 seconds" },
          ],
        },
      },
    },
